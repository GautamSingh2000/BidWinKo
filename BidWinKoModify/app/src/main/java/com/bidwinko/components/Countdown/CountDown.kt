package com.bidwinko.components.Countdown

import android.os.CountDownTimer
import android.widget.SeekBar
import android.widget.TextView
import com.bidwinko.components.CustomSeekBar
import java.util.Date

class CountDown {
    private var countDownTimer: CountDownTimer? = null

    fun start(startTime: Long , endTime: Long, textView: TextView, seekBar: CustomSeekBar?) {
        try {
